...
#
#
def compChooseWord(hand, wordScores, n):
    """
    ...
    for word in wordScores:
        ...
        if isValidWord(word, hand, wordScores):
...
def compPlayHand(hand, wordList, n):
    ...
    while (calculateHandlen(hand) > 0) :
        ...
        displayHand(hand)
        # computer's word
        word = compChooseWord(hand, wordScores, n)
        ...
        # Otherwise (the input is not a single period):
            ...
            if (not isValidWord(word, hand, wordScores)) :
...
def playGame(wordList):
    ...
    while not userInput == "e":
        if userInput == "n" or userInput == "r":
            ...
            while not whoPlays == "c" and not whoPlays == "u":
...
if __name__ == '__main__':
    ...
    for word in wordList:
        wordScores[word] = getWordScore(word, HAND_SIZE)
    playGame(wordList)
